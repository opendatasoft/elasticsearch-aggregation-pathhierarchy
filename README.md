...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-pathhierarchy/releases/download/v6.6.2.2/pathhierarchy-aggregation-6.6.2.2.zip`
...
| 6.6.2 | 6.6.2.2 | https://github.com/opendatasoft/elasticsearch-aggregation-pathhierarchy/releases/download/v6.6.2.2/pathhierarchy-aggregation-6.6.2.2.zip |
