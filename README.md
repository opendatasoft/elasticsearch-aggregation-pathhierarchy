...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-pathhierarchy/releases/download/v6.6.2.1/pathhierarchy-aggregation-6.6.2.1.zip`
...
| 6.6.2 | 6.6.2.1 | https://github.com/opendatasoft/elasticsearch-aggregation-pathhierarchy/releases/download/v6.6.2.1/pathhierarchy-aggregation-6.6.2.1.zip |
