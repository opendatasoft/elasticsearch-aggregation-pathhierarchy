...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-pathhierarchy/releases/download/v6.5.2.0/pathhierarchy-aggregation-6.5.2.0.zip`
...
| 6.5.2 | 6.5.2.0 | https://github.com/opendatasoft/elasticsearch-aggregation-pathhierarchy/releases/download/v6.5.2.0/pathhierarchy-aggregation-6.5.2.0.zip |
